...
public class PropertyCommand {
    ...
    @Parameter(description = "intermine items database name, default from INTERMINE_ITEMS_DB", names = {"-idb", "--items-database"})
    ...
    @Parameter(names={"--tomcat-host", "-th"}, description = "tomcat host, default from TOMCAT_SERVICE_HOST")
    public String thost = System.getenv("TOMCAT_SERVICE_HOST");

    @Parameter(names={"--tomcat-port", "-tport"}, description = "tomcat port, default from TOMCAT_SERVICE_PORT")
